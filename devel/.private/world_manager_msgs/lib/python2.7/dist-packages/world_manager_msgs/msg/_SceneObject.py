...
"""autogenerated by genpy from world_manager_msgs/SceneObject.msg. Do not edit."""
import sys
...
class SceneObject(genpy.Message):
  _md5sum = "20f36b7419e69e39d65a739459b9e19b"
  _type = "world_manager_msgs/SceneObject"
...
float64 w
"""
  __slots__ = ['object_name','mesh_filepath','pose_stamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       object_name,mesh_filepath,pose_stamped
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.mesh_filepath = str[start:end].decode('utf-8')
      else:
        self.mesh_filepath = str[start:end]
      _x = self
      start = end
      end += 12
