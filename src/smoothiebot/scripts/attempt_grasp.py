...
if __name__ =="__main__":
	...
	manager = GraspManager()
        # Setting up for ipython test
        grasps = manager.plan_grasps()
        moveit_graspit_msg = manager.graspit_grasp_to_moveit_grasp('apple', grasps[0])
        manager.grasping_controller.analyze_moveit_grasp('apple', moveit_graspit_msg)
